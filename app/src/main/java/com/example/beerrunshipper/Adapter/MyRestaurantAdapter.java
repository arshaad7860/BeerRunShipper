package com.example.beerrunshipper.Adapter;
...
import com.example.beerrunshipper.Callback.IRecyclerClickListener;
...
import com.example.beerrunshipper.R;
...
public class MyRestaurantAdapter extends RecyclerView.Adapter<MyRestaurantAdapter.MyViewHolder> {
    ...
    public MyRestaurantAdapter(Context context, List<RestaurantModel> restaurantModels) {
        this.restaurantModelList = restaurantModels;
